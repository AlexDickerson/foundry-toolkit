...
describe('generateAsciiMap', () => {
  ...
  it('should show multi-cell tokens', () => {
    const input = baseInput({
      tokens: [{ id: 't1', name: 'Huge Dragon', x: 100, y: 100, width: 2, height: 2 }],
    });
  ...
  it('should include HP in legend', () => {
    const input = baseInput({
      tokens: [{ id: 't1', name: 'Goblin', x: 100, y: 100, width: 1, height: 1, hp: { value: 5, max: 7 } }],
    });
  ...
  it('should show token without HP', () => {
    const input = baseInput({
      tokens: [{ id: 't1', name: 'Mystery', x: 100, y: 100, width: 1, height: 1 }],
    });
  ...
  it('should show size in legend for large tokens', () => {
    const input = baseInput({
      tokens: [{ id: 't1', name: 'Ogre', x: 100, y: 100, width: 2, height: 2 }],
    });
