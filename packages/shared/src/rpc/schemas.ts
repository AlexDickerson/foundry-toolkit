...
// because each action interprets its own shape (craft reads
// `itemUuid`/`quantity`, a future cast-spell would read something
// else). The bridge handler narrows at runtime.
